...
import com.example.harvic.blogrecyclerviewsec.decoration.DecorationActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.decoration_activity_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
