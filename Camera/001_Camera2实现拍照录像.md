...
按照教程[Camera2 API Video](https://www.nigeapptuts.com/category/camera2-api-video/)来实现，原教程代码：

+ [android_camera2_api_video_app](https://github.com/mobapptuts/android_camera2_api_video_app)
...
+ [CameraVideo](https://github.com/winfredzen/Android-Basic/tree/master/Camera/code/CameraVideo)

效果如下：

![003](https://github.com/winfredzen/Android-Basic/blob/master/Camera/images/003.png)
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION_RESULT) {
            ...
            if (grantResults[1] != PackageManager.PERMISSION_GRANTED) {//Audio
                Toast.makeText(getApplicationContext(), "Application will not run have audio record", Toast.LENGTH_SHORT).show();
            }
        }
    ...
    private void setupMediaRecorder() throws IOException {
        ...
        mMediaRecorder.setAudioSource(MediaRecorder.AudioSource.MIC);//这里貌似要注意设置的顺序
